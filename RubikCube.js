...
class RubikCube {
	constructor(gl, program, subcubeLength, numSubcubesPerLine, offsetBtwSubcubes, verticies, colors, normals, textures){
		this.setEnvironmentVariables(gl, program, subcubeLength, numSubcubesPerLine, offsetBtwSubcubes, verticies, colors, normals, textures);
		this.initilizeMatrices();
		this.loadWebGLBuffer();
	}
}

RubikCube.prototype.setEnvironmentVariables = function(gl, program, subcubeLength, numSubcubesPerLine, offsetBtwSubcubes, verticies, colors, normals, textures){
	this.gl = gl;
